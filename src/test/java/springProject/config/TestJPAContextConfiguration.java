...
@Configuration
@ComponentScan(basePackages = { "br.com.season.springproject.entity", "br.com.season.springproject.dao",
		"br.com.season.springproject.service" })
public class TestJPAContextConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactoryBean() {
		...
		lcef.setPackagesToScan(new String[] { "br.com.season.springproject.entity" });
